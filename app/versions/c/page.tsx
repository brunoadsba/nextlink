    ...
    <div className="min-h-screen bg-blue-950 text-white font-sans">
      <main className="container mx-auto px-4 py-8 lg:py-12">
        ...
        <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-gradient-to-br from-blue-800/40 to-blue-900/20 p-8 rounded-2xl shadow-md border border-blue-500/30 hover:border-blue-400/60 transition-all duration-300 flex flex-col items-center hover:scale-105">
            ...
            <p className="text-xs text-gray-400 mt-1">Análises de especialistas</p>
          </div>
          
          <div className="bg-gradient-to-br from-green-800/40 to-green-900/20 p-8 rounded-2xl shadow-md border border-green-500/30 hover:border-green-400/60 transition-all duration-300 flex flex-col items-center hover:scale-105">
            ...
            <p className="text-xs text-gray-400 mt-1">Sessões interativas</p>
          </div>
          
          <div className="bg-gradient-to-br from-yellow-800/40 to-yellow-900/20 p-8 rounded-2xl shadow-md border border-yellow-500/30 hover:border-yellow-400/60 transition-all duration-300 flex flex-col items-center hover:scale-105">
            <Code className="w-12 h-12 text-yellow-400 mb-4 group-hover:scale-110 transition-transform" />
            <h4 className="font-bold text-white text-lg mb-2">Artigos Técnicos</h4>
            <p className="text-xs text-yellow-200">
              {realArticles.length} artigos especializados
            </p>
            <p className="text-xs text-gray-400 mt-1">Aprofundamento em temas</p>
          </div>
          
          <div className="bg-gradient-to-br from-red-800/40 to-red-900/20 p-8 rounded-2xl shadow-md border border-red-500/30 hover:border-red-400/60 transition-all duration-300 flex flex-col items-center hover:scale-105">
            <CheckCircle className="w-12 h-12 text-red-400 mb-4 group-hover:scale-110 transition-transform" />
            <h4 className="font-bold text-white text-lg mb-2">Desafios Interativos</h4>
            <p className="text-xs text-red-200">
              {realQuizzes.length} avaliações disponíveis
            </p>
            <p className="text-xs text-gray-400 mt-1">Avalie seu conhecimento</p>
          </div>
        </section>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {realArticles.slice(0, 3).map((article, index) => (
              <div 
                key={article.id} 
                className="bg-gradient-to-br from-gray-800/60 to-gray-900/40 p-6 rounded-2xl shadow-lg border border-gray-600/30 hover:border-blue-400/50 transition-all duration-300 hover:scale-105"
              >
                <div className="flex items-center gap-2 mb-4">
                  <div className={`w-3 h-3 rounded-full ${
                    index === 0 ? 'bg-blue-400' : index === 1 ? 'bg-green-400' : 'bg-yellow-400'
                  }`}></div>
                  <span className="text-xs text-gray-400 uppercase tracking-wide">{article.category}</span>
                </div>
        ...
        <section className="mb-20 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-blue-400 mb-16">
            Impacto SESI 2025
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-800/30 to-blue-900/20 p-8 rounded-2xl shadow-lg border border-blue-500/30">
            ...
            <div className="bg-gradient-to-br from-green-800/30 to-green-900/20 p-8 rounded-2xl shadow-lg border border-green-500/30">
            ...
            <div className="bg-gradient-to-br from-yellow-800/30 to-yellow-900/20 p-8 rounded-2xl shadow-lg border border-yellow-500/30">
            ...
            <div className="bg-gradient-to-br from-purple-800/30 to-purple-900/20 p-8 rounded-2xl shadow-lg border border-purple-500/30 md:col-span-2 lg:col-span-1">
            ...
            <div className="bg-gradient-to-br from-indigo-800/30 to-indigo-900/20 p-8 rounded-2xl shadow-lg border border-indigo-500/30 md:col-span-2 lg:col-span-2">
