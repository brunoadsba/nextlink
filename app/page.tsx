...
export default function HomePage() {
  return (
    <main>
      {/* Header */}
      <header className="hero-gradient text-white section">
        <div className="container-custom">
          <div className="text-center fade-in">
            <div className="mb-6">
              <Link2 className="w-16 h-16 mx-auto mb-4 text-emerald-300" />
            </div>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold serif-font mb-6">
              Next Link
            </h1>
            <p className="text-lg md:text-xl lg:text-2xl font-light mb-8 max-w-3xl mx-auto px-4">
              Inovação e Tecnologia • Instituto SESI de SST
            </p>
            <div className="inline-flex items-center bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-full px-4 md:px-6 py-3">
      ...
      {/* Contexto */}
      <section className="section bg-gradient-to-br from-blue-50 to-emerald-50">
        <div className="container-custom">
          <div className="text-center mb-8 md:mb-12 fade-in px-4">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold gradient-text serif-font mb-6">
              Contexto
            </h2>
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-base md:text-lg text-gray-600 leading-relaxed">
                Assim, criamos o <span className="font-bold text-emerald-600">Next Link - Inovação e Tecnologia</span> do Instituto SESI de SST, um espaço para compartilhar conteúdos relevantes sobre inovação e tecnologia, em diversos formatos: podcasts, lives, quizzes, trilhas de aprendizagem, curiosidades e muito mais.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
            <div className="card-glass p-6 md:p-8 fade-in">
              ...
              <div className="highlight-box">
                <p className="font-medium text-gray-700 text-sm md:text-base">Levar conhecimento ao cliente interno do Instituto SESI de SST sobre as principais tendências em inovação e tecnologia nas áreas de atuação.</p>
              </div>
            </div>
            ...
            <div className="card-glass p-6 md:p-8 fade-in">
              ...
              <div className="highlight-box">
                <p className="font-medium text-gray-700 text-sm md:text-base">Gerar engajamento por meio de conteúdos que aumentem a capacidade de identificar soluções e aprimorar processos internos.</p>
              </div>
            </div>
            ...
            <div className="card-glass p-6 md:p-8 fade-in">
              ...
              <div className="highlight-box">
                <p className="font-medium text-gray-700 text-sm md:text-base">Incentivar a proposição de soluções incrementais, inovadoras e disruptivas.</p>
              </div>
            </div>
          </div>
        </div>
